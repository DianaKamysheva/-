...
while True:
    try:
        a = str(input('Главное меню\n\n'
                      ...
                      '5. Сортировка дисциплин (В разработке)\n'
                      '6. Сортировка по отчётности (В разработке)\n'
                      '7. Список дисциплин с общим количеством часов в заданном диапазоне (В разработке)\n'
                      'Ваш ввод: '))
        if a == '1':
            add_discipline(A)
        elif a == '2':
